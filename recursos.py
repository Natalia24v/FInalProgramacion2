...
class RecursoBodegas(Resource):
    def get(self):
        ...
        return json.loads(json.dumps(bodegas, default=lambda o: o.convertirAJSON())), 200
...
class RecursoCepas(Resource):
    def get(self):
        ...
        return json.loads(json.dumps(cepas, default=lambda o: o.convertirAJSONFull())), 200
